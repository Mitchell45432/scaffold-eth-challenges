...
contract Staker {
  ...
  uint256 public constant rewardRatePerSecond = .3333 ether; 
  uint256 public withdrawalDeadline = block.timestamp + 180 seconds; 
  uint256 public claimDeadline = block.timestamp + 360 seconds; 
  ...
  */
  function withdraw() public withdrawalDeadlineReached(true) claimDeadlineReached(false) notCompleted{
    ...
    (bool success, bytes memory data) = msg.sender.call{value: indBalanceRewards}("");
  ...
  */
  ...
  /*
  Allows specific users (whitelisted per say) to claim "unproductive" funds that are left in the staking contract
  past the defined withdrawal period
  */
  function claim() public claimDeadlineReached(true) notCompleted {
